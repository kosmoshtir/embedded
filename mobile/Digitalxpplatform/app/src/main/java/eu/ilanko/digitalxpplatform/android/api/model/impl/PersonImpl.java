...
import eu.ilanko.digitalxpplatform.android.api.model.Company;
...
public class PersonImpl implements Person
{
    ...
    /**
     * Parse Json Response from Ilanko REST API to create a Person.
     *
    ...
    /**
     * Parse Json Response from Ilanko Public API to create a Person.
     *
     * @param json : json response that contains data from the repository
     * @return Person object that contains essential information about it.
     */
