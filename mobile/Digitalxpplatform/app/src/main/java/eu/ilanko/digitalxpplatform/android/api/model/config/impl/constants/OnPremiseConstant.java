...
public interface OnPremiseConstant
{
    ...
    // EDITION
    String ILANKO_VENDOR = "Ilanko";

    String ILANKO_EDITION_COMMUNITY = "Community";

    String ILANKO_EDITION_ENTERPRISE = "Enterprise";

    String ILANKO_EDITION_UNKNOWN = "unknown";
    ...
    // VERSION NUMBER
    int ILANKO_VERSION_4_2 = 2;

    int ILANKO_VERSION_5 = 5;

    int ILANKO_VERSION_4 = 4;

    int ILANKO_VERSION_3 = 3;
