...
extern uint8_t g_nvm_runlevel;   // NanoVM system runlevel
...
extern uint8_t g_nvc2_address;       // System address
extern uint8_t g_nvc2_msg_status;    // NVM-Comm2 tracked message status byte
extern uint8_t g_nvc2_query_status;  // NVM-Comm2 query status byte
extern uint8_t g_nvc2_track;         // NVM-Comm2 tracking position
extern uint8_t g_nvc2_le;            // NVM-Comm2 message length
extern uint8_t g_nvc2_msgid;         // message id
extern uint8_t g_nvc2_lastid;        // last message id
extern uint16_t g_nvc2_crc;           // message crc
extern uint8_t g_nvc2_command;       // Used only if (g_nvc2_msg_status & NVC2_QUERY_COMMAND) > 0.
...
extern uint8_t g_nvc2_data[NVC2_BUFFER_SIZE];
extern size_t g_nvc2_dsize;

extern int_t g_nvc2_file_open;     // open file id (id 0 = firmware);
extern uint16_t g_nvc2_file_pos;      // read/write position in open file

extern bool g_nvc2_query_success;  // success of last query
extern uint8_t g_nvc2_query_rsize;   // last response length
...
bool nvc2_proc_input(uint8_t value);
